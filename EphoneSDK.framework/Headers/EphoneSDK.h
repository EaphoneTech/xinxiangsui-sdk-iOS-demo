...
//! Project version number for EphoneSDK.
FOUNDATION_EXPORT double EphoneSDKVersionNumber;

//! Project version string for EphoneSDK.
FOUNDATION_EXPORT const unsigned char EphoneSDKVersionString[];
